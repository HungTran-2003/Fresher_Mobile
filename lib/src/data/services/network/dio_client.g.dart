...
class _DioClient implements DioClient {
  ...
  @override
  Future<BaseResponse<TokenModel>> login(Map<String, dynamic> body) async {
  ...
  Future<BaseListResponse<ProductModel>> getProducts({
    ...
    final _options = _setStreamType<BaseListResponse<ProductModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseListResponse<ProductModel> _value;
    try {
      _value = BaseListResponse<ProductModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<BaseListResponse<CategoryModel>> getCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseListResponse<CategoryModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/categories',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseListResponse<CategoryModel> _value;
    try {
      _value = BaseListResponse<CategoryModel>.fromJson(
        _result.data!,
